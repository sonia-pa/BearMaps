...
public class RasterAPIHandler extends APIRouteHandler<Map<String, Double>, Map<String, Object>> {
    ...
    public Map<String, Object> processRequest(Map<String, Double> requestParams, Response response) {
        ...
        int depth = ImageDepth(ullon, lrlon, width);


        if ( ullon > Constants.ROOT_LRLON  ||  ullat < Constants.ROOT_LRLAT
                || lrlon < Constants.ROOT_ULLON  || Constants.ROOT_ULLAT < lrlat
    ...
    public  int ImageDepth(double ullon, double lrlon, double width) {
        ...
        return depth;
//        int x = (int) (lonDPP/ maxLonDPP);
//
//        if (lonDPP > maxLonDPP){
//            depth = (int) (Math.log(x) / Math.log(2));
//        }
//        return depth;
    }
